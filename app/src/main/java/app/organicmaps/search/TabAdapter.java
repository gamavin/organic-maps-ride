...
import app.organicmaps.bookmarks.RidehailingBookmarksFragment;
...
class TabAdapter extends FragmentPagerAdapter
{
  enum Tab
  {
    ...
    BOOKMARKS { // Diganti dari CATEGORIES
      @Override
      public int getTitleRes()
      {
        return R.string.bookmarks; // Diubah dari R.string.categories
      }

      @Override
      public Class<? extends Fragment> getFragmentClass()
      {
        return RidehailingBookmarksFragment.class;
      }
    };
